...
VALUES ('Crossroads accident', 'Two cars crashed at an intersection', 'Victory street, 2', 1),
       ('Pedestrian collision',
        'The car was driving on the sidewalk and hit a pedestrian', 'Bucharest street, 39', 2),
       ('Motorcycle in a ditch',
        'The motorcycle did not let the car pass and flew to the side of the road',
